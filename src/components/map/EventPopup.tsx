...
export function EventDetailCard({
  ...
  const typeDotClass = EVENT_TYPE_DOT_COLOR[event.type] ?? "bg-muted-foreground";
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain px-5 pb-5">
        ...
        <h3 className="text-lg font-bold text-card-foreground mb-1.5 leading-snug">{event.title}</h3>
  ...
  return (
    ...
    >
      <div className="bg-card rounded-2xl shadow-lg shadow-black/10 max-h-[calc(100dvh-10rem)] overflow-y-auto overscroll-contain p-5 relative border border-border">
        ...
        <h3 className="text-xl font-bold text-card-foreground mb-1.5 pr-12">{displayEvent.title}</h3>
        ...
        <div className="space-y-2 mb-4 text-[0.9375rem] text-muted-foreground">
          <div className="flex items-start gap-2">
            <DooIcon name="calendar" size={16} className="mt-0.5 shrink-0" aria-hidden="true" />
